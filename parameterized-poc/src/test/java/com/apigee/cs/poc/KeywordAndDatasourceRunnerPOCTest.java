...
import com.apigee.cs.extensions.junit.CustomDataAndKeywordSourceRunner;
import com.apigee.cs.extensions.junit.DatasourceRunner;
import com.apigee.cs.extensions.junit.CustomDataAndKeywordSourceRunner.SpreadsheetSource;
...
@RunWith(value=CustomDataAndKeywordSourceRunner.class)
public class KeywordAndDatasourceRunnerPOCTest extends AbstractSMSTest {
	...
	Logger log = LoggerFactory.getLogger(this.getClass());
	  ...
	  * @throws Exception
	  */
	 public KeywordAndDatasourceRunnerPOCTest(AbstractTestdataBase param) throws Exception{
	...
	public static Object DataSource() throws Exception{
		return new File(URLDecoder.decode(ParamsVO.class
							.getClassLoader().getResource("DataAndKeywordDrivenPOC.xlsx")
							.getFile(), "UTF-8"));	
		}
